...
-- Highlight the column ruler at 100 characters
vim.o.colorcolumn = '100'

-- Enables automatic indentation based on syntax and code structure for programming languages.
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sm', telescope.live_multigrep, { desc = '[S]earch [M]ultigrep' })
